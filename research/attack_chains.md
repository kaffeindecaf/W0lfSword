# W0lfSword — iOS Attack Chain Designs (2025–2026 Landscape)

> **Repo:** `/home/kaffein/Desktop/W0lfSword` (kaffeindecaf) — DarkSword kernel-R/W toolkit, v1.1.0
> **Date:** 2026-08-29 · **Author:** Hermes subagent (attack-chain design task, ROADMAP C5.3)
...
2. **Chain G G1 (FontParser diff 18.4.1↔18.7.1)** — highest single-leverage research action; unlocks the complete SE2 chain.
