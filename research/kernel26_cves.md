# iOS 26.1+ kernel CVEs (C5.1)

**Date:** 2026-08-29 . **Scope:** xnu/kernel bugs fixed in iOS 26.1 to 26.6.1, evaluated as local privilege-escalation candidates usable from a sandboxed app, for re-opening the kernel gate closed by the DarkSword patch in 26.1.
