# W0lfSword — iOS Userspace Escape Inventory 2025–2026
## Sandbox escapes · TCC bypasses · SSV bypasses — CVE + technique survey with live-vs-patched assessment
...
> **Compiled:** 2026-08-29 · **Baseline versions:** iOS **18.4.1** (released 2025-04-16) and the **26.x** line (26.0 Sep 2025 → 26.6.1).
> **Method:** Primary sources = Apple security release pages (fetched & parsed directly), NVD, GTIG/iVerify/Lookout disclosures, researcher blogs. No CVE is invented; anything not directly verifiable is marked **UNVERIFIED**.
...
## 5. TOP 10 FINDINGS (live-status flagged)
